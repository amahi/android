...
/**
 * Navigation activity. This is an entry point of the application. Shows navigation between main
 * application sections (shares, apps) and shares and apps lists itself. On phones the activity uses
 * the navigation drawer, on tablets drawer is always visible. The navigation itself is done via
 * {@link org.amahi.anywhere.fragment.NavigationFragment}, {@link org.amahi.anywhere.fragment.ServerSharesFragment}
 * and {@link org.amahi.anywhere.fragment.ServerAppsFragment}.
 */
