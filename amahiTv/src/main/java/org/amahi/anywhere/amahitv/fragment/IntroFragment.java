...
import org.amahi.anywhere.amahitv.activity.MainActivity;
...
public class IntroFragment extends OnboardingFragment {
    ...
    private static final int[] CONTENT_IMAGES = {
            R.drawable.logo_amahi,
            R.drawable.network,//Browse fragment pic
            R.drawable.photos,//photo fragment pic
            R.drawable.music,//music fragment pic
            R.drawable.movies,//video playback pic
            R.drawable.tick,
    };
    ...
    public void onAttach(Context context) {
        ...
        mDescriptions.add("View all your photos backed up in your HDA directly in your Android TV.");
        mTitles.add("Listen to your music");
        mDescriptions.add("Listen to all of your songs in your HDA directly in your Android TV.");
        ...
        setLogoResourceId(R.drawable.logo_amahi);
    }
