...
public class ConnectionFragment extends GuidedStepFragment{
    ...
    private final String[] OPTION_DESCRIPTIONS = {"","","",""};

    private final int[] OPTION_DRAWABLES = {R.drawable.ic_app_logo};

    private final boolean[] OPTION_CHECKED = {true, false, false,false};
    ...
    public GuidanceStylist.Guidance onCreateGuidance(Bundle savedInstanceState) {
        ...
        String description =getString(R.string.pref_connection_detail);
